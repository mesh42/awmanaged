...
namespace AwManaged.Scene.ActionInterpreter
{
    ...
    public sealed class ACAnimate : IActionCommand
    {
        ...
        public ACAnimate(string tag, string mask, Model model, string animationName, int imageCount, int frameCount, Int64 frameDelay, List<int> frameList, bool isGLobal)
        {
            _tag = tag;
            _mask = mask;
            _model = model;
