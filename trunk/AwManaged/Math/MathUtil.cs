...
namespace AwManaged.Math
{
    ...
    public sealed class MathUtil
    {
        ...
        /// </returns>
        /// Submitted by: romout
        public static AwManaged.Math.Intersection Intersects(AxisAlignedBox boxA, AxisAlignedBox boxB)
        {
                ...
                (maxB.z > maxA.z))
            {
                ...
                // boxA is within boxB
                return AwManaged.Math.Intersection.Contained;
            }
                ...
                (maxB.z < maxA.z))
            {
                ...
                // boxB is within boxA
                return AwManaged.Math.Intersection.Contains;
            }
                ...
                (maxB.z < minA.z))
            {
                ...
                return AwManaged.Math.Intersection.None;
            }

            // if we got this far, they are partially intersecting
            return AwManaged.Math.Intersection.Partial;
        }
