...
/*-----------------------------------------------------------------------------
                  Copyright 1998-2008 Activeworlds Inc.
...
#define AW_PERSONAL_AVATAR          65535
#define AW_CUSTOM_AVATAR            65534
#define AW_CUSTOM_WORLD_AVATAR      65533
...
-----------------------------------------------------------------------------*/
#ifdef LINUX
#pragma pack (push, aw_api, 1)        // Store current structure packing alignment
#else
